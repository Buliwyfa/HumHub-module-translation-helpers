...
use humhub\modules\translation\libs\GoogleTranslate;
                        ...
                        <div>
                            ...
                            <div class="elem">
								...
								<button type="button" class="btn btn-success btn-sm btn_copy_suggested_2_empty">
									...
									<?php 
										//ioxoi
										echo Yii::t('TranslationModule.views_translate_index', 'COPY suggested to all empty');
									?>
								</button>
							</div>
                        </div>
                            ...
                            <div class="row ">
                               ...
                               <div class="elem">
									...
									>
										...
										<?php 
											//ioxoi
											echo Yii::t('TranslationModule.views_translate_index', 'COPY suggested trasnlation');
										?>
									</button>
									</div>
									<?php 
										...
										//ioxoi
										echo Yii::t('TranslationModule.views_translate_index', 'Suggested translation:');
